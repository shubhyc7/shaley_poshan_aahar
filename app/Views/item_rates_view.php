...
<div class="card shadow-sm border-0 mb-1">
    <div class="card-header bg-white py-3 d-flex justify-content-between align-items-center">
        ...
        <div>
            <a href="<?= base_url('ItemRates/export?category=' . $filterCategory) ?>" class="btn btn-success me-2">
                    ...
                    <?php foreach ($rates as $rate) : ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="<?= base_url('ItemRates/delete/' . $rate['id'] . '?category=' . $filterCategory) ?>" class="btn btn-sm btn-outline-danger" onclick="return confirm('हटवायचे?')"><i class="fas fa-trash"></i></a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
        ...
        <form action="<?= base_url('ItemRates/store') ?>" method="POST" class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" step="0.00001" name="per_student_qty" class="form-control" required>
                </div>
            </div>
    ...
    <div class="modal-dialog">
        <form id="editRateForm" method="POST" class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="mb-3">
                    <label>प्रति विद्यार्थी प्रमाण</label>
                    <input type="number" step="0.00001" name="per_student_qty" id="edit_qty" class="form-control" required>
                </div>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">रद्द करा</button>
